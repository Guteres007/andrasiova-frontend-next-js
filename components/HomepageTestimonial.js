...
export default function HomepageTestimonial() {
    ...
    return (
        <div className={styles.testimonials}>
            <Container>
                <Row>
                    <Title dotsColor={'orange'}>Co říkají klienti</Title>
                </Row>
            </Container>
                    ...
                    <Row>
                        ...
                        <Col xl={8}>
                            <div className={styles.description}>
                                <p>
                                    <i>
                                        Poděkování za perfektně odvedenou službu by mělo být
                                        samozřejmostí, ale ve vašem případě chci vyjádřit své pocity
                                        i několika slovy navíc.
                                    </i>
                                </p>
                                <p>
                                    <i>
